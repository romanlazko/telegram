...
class Bot 
{
    ...
    public  function __construct(public string $token)
    {
        ...
        $this->api = BotApi::initialize($this);
    ...
    {
        $namespace = DB::getBot()?->namespace;

        if ($namespace) {
            return $namespace;
        }
        
        return $this->getBotChat()->getUsername();
    }
    ...
    {
        $commandsListClass  = "App\\Bots\\{$this->getNamespace()}\\Commands\\CommandsList";
